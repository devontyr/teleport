...
<Admonition type="tip" title="SSO users">
  ...
  In this case you should map the AWS Role ARNs through your Identity Provider, using [role templates](../../../zero-trust-access/rbac-get-started/role-templates.mdx#sso-users).
</Admonition>
