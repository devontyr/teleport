...
This page explains how you can configure role-based access controls for
Teleport-protected applications. It describes optionas availaable for the
Teleport Application Service and Teleport roles that grant or deny permissions
to access applications through Teleport.
