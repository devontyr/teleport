...
This page explains how you can configure Teleport-protected applications using
the dynamic application resource, and how you can enable Teleport Application
Service instances to discover dynamic application resources.
...
See the full app resource spec [reference](../reference.mdx).
