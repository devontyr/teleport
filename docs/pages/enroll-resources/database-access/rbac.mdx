...
This page explains how configuration options in Teleport roles and database
object import rules allow you to restrict the operations that users can perform
against Teleport-protected databases.
...
[RBAC](../../zero-trust-access/authentication/authentication.mdx), as this section focuses on
...
spec:
  allow:
    ...
    #
    # Also note, database names are only enforced for PostgreSQL, MongoDB, and
...
Similar to PostgreSQL, Teleport also enforces `db_names` for MongoDB and Cloud
Spanner databases.
