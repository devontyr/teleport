...
configuring Database Service replicas to watch for the same database resources.
...
See the full database resource [reference](../../../reference/infrastructure-as-code/teleport-resources/database-v3.mdx).
